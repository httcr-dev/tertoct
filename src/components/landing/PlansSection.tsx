    ...
    <section id="plans" className="mt-32 flex w-full flex-col items-center">
      ...
      {plans.length > 0 && !loadingLandingData && (
        <div className="mb-10 flex items-center gap-3">
          <label htmlFor="sort-plans" className="text-xs font-bold uppercase tracking-widest text-zinc-500">
            Ordenar por:
          </label>
          <select
            id="sort-plans"
            ...
            className="rounded-xl border border-zinc-800 bg-zinc-900/50 px-4 py-2 text-xs font-bold text-zinc-200 transition-all focus:border-[#c29b62]/50 focus:outline-none"
          >
